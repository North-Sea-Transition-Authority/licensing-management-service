...
class SummaryFileViewTest {
  ...
  private static final UploadedFile UPLOADED_FILE_1 = new UploadedFile(FILE_ID_1);
  ...
  private static final UploadedFile UPLOADED_FILE_2 = new UploadedFile(FILE_ID_2);
