...
public class UpdateCorrectionGeneralDetailsController {
  ...
  public ModelAndView renderUpdateGeneralDetails(
    ...
    form.getCorrectionReference().setInputValue(correction.getCorrectionReference());
    form.getReason().setInputValue(correction.getReason());

    return updateGeneralDetailsModelAndView(correction, form);
  }
  ...
  ModelAndView updateGeneralDetails(
    ...
    if (updateCorrectionGeneralDetailsFormValidator.hasErrors(form, bindingResult)) {
      return updateGeneralDetailsModelAndView(correction, form);
    }

    licenceCorrectionService.updateGeneralDetails(
        correction,
