<template>
  <div v-if="divider" class="govuk-checkboxes__divider">
    {{ divider }}
  </div>
  <div class="govuk-checkboxes__item">
    <input
      ...
      v-bind="$attrs"
    >
    <gv-label :text="label" class="govuk-checkboxes__label" :class="labelClass" :for-id="computedId">
...
import { useComputedId } from "../../gdsComponents/composables/useComputedId";
...
const parentModelValue = inject(CheckboxesModelValueInjectionKey, ref(undefined));
...
const checked = computed(() => {
  return modelValueMutable.value === props.trueValue;
});
