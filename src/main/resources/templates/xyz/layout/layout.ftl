...
<#-- @ftlvariable name="loggedInUser" type="uk.co.nstauthority.template.authentication.ServiceUserDetail" -->
...
<#-- @ftlvariable name="notificationBanner" type="uk.co.nstauthority.template.fds.notificationbanner.NotificationBanner" -->
