...
@Audited
@Entity(name = "swp_record_of_decision_reduction")
public class RecordOfDecisionReduction {
  ...
  @Embedded
  @AttributeOverride(name = "days", column = @Column(name = "reduction_duration_days"))
  @AttributeOverride(name = "months", column = @Column(name = "reduction_duration_months"))
  @AttributeOverride(name = "years", column = @Column(name = "reduction_duration_years"))
  private ThreeFieldDuration reductionDuration;
  ...
  public ThreeFieldDuration getReductionDuration() {
    return reductionDuration;
  }

  public void setReductionDuration(ThreeFieldDuration reductionDuration) {
