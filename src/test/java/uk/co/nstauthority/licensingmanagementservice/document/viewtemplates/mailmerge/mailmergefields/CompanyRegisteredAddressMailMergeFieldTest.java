...
class CompanyRegisteredAddressMailMergeFieldTest {

  @Mock
  private DocumentLinkingService linkingService;

  @InjectMocks
  private CompanyRegisteredAddressMailMergeField mailMergeField;

  @Test
  void getMnemonic() {
    assertThat(mailMergeField.getMnemonic()).isEqualTo(CompanyRegisteredAddressMailMergeField.MNEMONIC);
  }

  @Test
  void getDescription() {
    assertThat(mailMergeField.getDescription()).isEqualTo(CompanyRegisteredAddressMailMergeField.DESCRIPTION);
  }
