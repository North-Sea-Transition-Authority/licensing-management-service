...
public enum Role {
  ...
  APPLICATION_EDITOR("Application editor", "Can create, edit and view applications on behalf of this organisation"),
  APPLICATION_SUBMITTER("Application submitter", "Can create, edit, submit and view applications on behalf of this organisation"),
