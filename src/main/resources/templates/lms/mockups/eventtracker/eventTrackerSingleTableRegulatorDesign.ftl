    ...
    <@fdsSearch.searchPage>
        ...
        <@fdsSearch.searchFilter>
            ...
            clearFilterUrl="#">
                ...
                <@fdsSearch.searchFilterItem itemName="Event status" expanded=true>
            ...
            <table class="govuk-table">
                ...
                <tbody class="govuk-table__body">
                    <tr class="govuk-table__row">
                        ...
                        <td class="govuk-table__cell">DSP ready</td>
                    ...
                    <tr class="govuk-table__row">
                        ...
                        <td class="govuk-table__cell">Framing</td>
                        <td class="govuk-table__cell">APACHE NORTH SEA LIMITED</td>
                        <td class="govuk-table__cell">31</td>
                        <td class="govuk-table__cell">Andy Admin</td>
                    </tr>
                    <tr class="govuk-table__row">
                        ...
                        <td class="govuk-table__cell">Issue decision</td>
                        <td class="govuk-table__cell">BP EXPLORATION</td>
                        <td class="govuk-table__cell"></td>
                        <td class="govuk-table__cell">Andy Admin</td>
                    </tr>
                    ...
                    <tr class="govuk-table__row">
                        ...
                        <td class="govuk-table__cell"></td>
                        <td class="govuk-table__cell">30 March 2026</td>
                        <td class="govuk-table__cell">Consult</td>
                        <td class="govuk-table__cell">BP EXPLORATION</td>
                        <td class="govuk-table__cell">31</td>
                        <td class="govuk-table__cell">Andy Admin</td>
                    </tr>
                    ...
                    <tr class="govuk-table__row">
                        ...
                        <td class="govuk-table__cell">Initial Term to Second Term</td>
                        <td class="govuk-table__cell"></td>
                        <td class="govuk-table__cell">30 April 2026</td>
                        <td class="govuk-table__cell">Consult</td>
                        <td class="govuk-table__cell">APACHE NORTH SEA LIMITED</td>
                        <td class="govuk-table__cell">29</td>
                        <td class="govuk-table__cell">Andy Admin</td>
                    ...
                    <tr class="govuk-table__row">
                        ...
                        <td class="govuk-table__cell">Appraisal Term to Operational Term</td>
                        <td class="govuk-table__cell"></td>
                        <td class="govuk-table__cell">2 May 2026</td>
                        <td class="govuk-table__cell">Request submitted</td>
                        <td class="govuk-table__cell">SHELL CLAIR UK LIMITED</td>
                        <td class="govuk-table__cell"></td>
                        <td class="govuk-table__cell">Andy Admin</td>
