...
import uk.co.nstauthority.template.energyportal.organisationgroup.OrganisationGroupRestController;
...
import uk.co.nstauthority.template.teams.management.access.InvokingUserHasStaticRole;
import uk.co.nstauthority.template.teams.management.form.NewOrganisationTeamForm;
import uk.co.nstauthority.template.teams.management.form.NewOrganisationTeamFormValidator;
...
public class ScopedTeamManagementController {
  ...
  @InvokingUserHasStaticRole(teamType = TeamType.REGULATOR, role = Role.CREATE_MANAGE_ANY_ORGANISATION_TEAM)
  ...
  private ModelAndView getModelAndView() {
    return new ModelAndView("xyz/teamManagement/scoped/createOrganisationTeam")
        .addObject(
