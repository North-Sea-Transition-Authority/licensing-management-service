...
@Service
public class RecordOfDecisionSummarySectionService {

  private final List<SummarySectionService<RecordOfDecisionSummaryContext>> summarySectionServices;

  RecordOfDecisionSummarySectionService(
      List<SummarySectionService<RecordOfDecisionSummaryContext>> summarySectionServices
  ) {
    this.summarySectionServices = summarySectionServices;
  }

  public List<SummarySection> getSummarySections(RecordOfDecisionSummaryContext context, ServiceUserDetail user) {
