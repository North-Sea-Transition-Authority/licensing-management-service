package uk.co.nstauthority.template.xyzapplication.form;
...
import uk.co.nstauthority.template.file.FileControllerHelperService;
import uk.co.nstauthority.template.mvc.ReverseRouter;
import uk.co.nstauthority.template.xyzapplication.XyzApplication;
import uk.co.nstauthority.template.xyzapplication.XyzApplicationRestController;
import uk.co.nstauthority.template.xyzapplication.XyzApplicationSupportingDocumentFileUsage;
...
public class XyzApplicationFormController {
  ...
  private ModelAndView getModelAndView(XyzApplicationForm form, UUID applicationId) {
    ...
    var modelAndView = new ModelAndView("xyz/application/formPage")
