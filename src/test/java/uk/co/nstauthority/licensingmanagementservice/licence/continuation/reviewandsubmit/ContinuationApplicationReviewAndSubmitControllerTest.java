...
class ContinuationApplicationReviewAndSubmitControllerTest extends AbstractControllerTest {
  ...
  void setUp() {
    ...
    when(licenceScheduleStateService.getCurrentWorkProgrammeActivitiesViews(any())).thenReturn(List.of());
  }
  ...
  private void assertRenderPageModelsAttributesArePresent(
    ...
    resultActions
        ...
        .andExpect(model().attribute("breadcrumbs", Map.of(
            ...
            ReverseRouter.route(on(LicenceContinuationApplicationTaskListController.class).getTaskList(id, null, null)), "Task list"
        )))
