...
import uk.co.nstauthority.template.energyportal.user.EnergyPortalUserService;
...
import uk.co.nstauthority.template.teams.management.access.InvokingUserCanManageTeam;
import uk.co.nstauthority.template.teams.management.access.InvokingUserCanViewTeam;
import uk.co.nstauthority.template.teams.management.form.AddMemberForm;
import uk.co.nstauthority.template.teams.management.form.AddMemberFormValidator;
import uk.co.nstauthority.template.teams.management.form.MemberRolesForm;
import uk.co.nstauthority.template.teams.management.form.MemberRolesFormValidator;
import uk.co.nstauthority.template.teams.management.view.TeamTypeView;
import uk.co.nstauthority.template.teams.management.view.TeamView;
import uk.co.nstauthority.template.util.StreamUtil;
...
public class TeamManagementController {
  ...
  public ModelAndView renderTeamTypeList(ServiceUserDetail user) {
    ...
    return new ModelAndView("xyz/teamManagement/teamTypes")
  ...
  public ModelAndView renderTeamsOfType(@PathVariable String teamTypeSlug, ServiceUserDetail user) {
    ...
    if (teamType.isScoped()) {
      ...
      var modelAndView = new ModelAndView("xyz/teamManagement/teamInstances")
  ...
  public ModelAndView renderTeamMemberList(@PathVariable UUID teamId, ServiceUserDetail user) {
    ...
    return new ModelAndView("xyz/teamManagement/teamMembers")
  ...
  public ModelAndView renderAddMemberToTeam(@PathVariable UUID teamId,
    ...
    var team = teamManagementService.getTeam(teamId);
    return new ModelAndView("xyz/teamManagement/addMember")
        .addObject(
  ...
  public ModelAndView renderRemoveTeamMember(@PathVariable UUID teamId, @PathVariable Long wuaId) {
    ...
    return new ModelAndView("xyz/teamManagement/removeMember")
  ...
  private ModelAndView getUserTeamRolesModelAndView(Team team, Long wuaId) {
    ...
    return new ModelAndView("xyz/teamManagement/editMemberRoles")
